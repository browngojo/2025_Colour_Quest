...
def get_round_colours():
    ...
    while len(round_colours) < 4:
        potential_color = random.choice(all_colours_list)

        # Get the score and check it's not a duplicate
        if potential_color[1] not in colour_scores:
            round_colours.append(potential_color)
            colour_scores.append(potential_color[1])
    ...
    def check_rounds(self):
        ...
        try:
            ...
            if rounds_wanted > 0:
                ...
                # that when users play a new game, they don't see and error message
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        # create four button in a 2 x 2 grid
        ...
        self.hints_button = control_button_list[1]
    ...
    def round_results(self, user_choice):
        ...
        rounds_played = self.rounds_played.get()
        rounds_played += 1
        self.rounds_won.set(rounds_played)
